...
auth_channel = environ.get('AUTH_CHANNEL', '-1002234831649') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Cinipaiyanbot:Cinipaiyanbot@cluster0.3kxfxdw.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+AE3rZbaPfgNmODI1')
